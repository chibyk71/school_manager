        ...
        <div class="card p-4 mb-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <Dropdown v-model="filters.fee_type_id" :options="feeTypes" optionLabel="name" optionValue="id"
                        placeholder="Select Fee Type" class="w-full" />
                </div>
                <div>
                    <label class="block mb-1">Payment Status</label>
                    <Dropdown v-model="filters.payment_status" :options="['pending', 'success', 'failed']"
