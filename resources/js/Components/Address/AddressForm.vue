...
<!--
AddressForm.vue v2.0 ΓÇô Production-Ready Reusable Address Form (Fully Aligned with Address Module)
...
- Full v-model support for two-way binding (used in owner forms and Phase 4 UI).
- Cascading async selects powered by nnjeim/world API (Country ΓåÆ State ΓåÆ City) using your production AsyncSelect.vue.
...
- Type-safe with AddressFormData from address.ts ΓÇô no mismatched fields.
...
- Fixed AsyncSelect configuration to exactly match nnjeim/world documented endpoints:
  ΓÇó Countries: GET /api/countries?search=...
  ΓÇó States: GET /api/states?filters[country_id]=...
  ΓÇó Cities: GET /api/cities?filters[state_id]=...
...
- Core input component used by:
  ΓÇó Phase 4 UI (create/edit modal)
  ΓÇó owner forms (inline first address in create mode)
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    ...
                    <i
                        ...
                        v-tooltip.top="'Common in Nigeria ΓÇô e.g., Near GTBank, Opposite Shoprite'"
                    ></i>
                </label>
                <InputText
