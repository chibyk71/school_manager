...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('fee_installments', function (Blueprint $table) {
            $table->uuid('id')->primary()->comment('Primary key for the fee installment');
            $table->foreignUuid('school_id')->constrained('schools')->onDelete('cascade')->comment('The school associated with this fee installment');
            $table->foreignUuid('fee_id')->constrained('fees')->onDelete('cascade')->comment('The fee associated with this installment');
