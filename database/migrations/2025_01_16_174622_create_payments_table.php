...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payments', function (Blueprint $table) {
            ...
            $table->foreignUuid('school_id')->constrained('schools')->onDelete('cascade')->comment('The school associated with this payment');
            $table->foreignUuid('user_id')->constrained('users')->onDelete('cascade')->comment('The user (student) who made the payment');
            ...
            $table->foreignUuid('fee_installment_detail_id')->nullable()->constrained('fee_installment_details')->onDelete('cascade')->comment('The fee installment detail associated with this payment');
            $table->foreignUuid('fee_id')->nullable()->constrained('fees')->onDelete('cascade')->comment('The fee associated with this payment');
            $table->timestamps();
