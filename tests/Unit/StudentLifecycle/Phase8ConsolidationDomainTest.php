 ...
 *
 * Covers:
 * - obsolete StudentEnrollmentService classes gone
 * - Academic\Student shim shares table, traits, and relationships
 * - EnrollmentService rejects foreign-school admission and session IDs
...
test('Academic Student shim shares table, traits and relationship methods', function () {
    ...
    // Instance created as canonical is also Academic for instanceof only if same class;
    // subclass means Academic is-a Student, not the reverse.
    ...
    // Shim query uses same table and can load the row
...
test('double finalize is rejected after first successful finalization attempt path', function () {
    ...
    // Simulate active finalized state (identity already linked) to prove second finalize is blocked
