...
/**
 * Request validation for updating a student.
 *
...
class UpdateStudentRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('update-students');
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'school_section_id' => 'sometimes|exists:school_sections,id,school_id,' . $school->id,
    ...
    protected function getActiveSchool(): School
    {
        ...
        if (!$school) {
            Log::error('No active school found during student update.');
