...
class EmailTemplatesController extends Controller
{
    ...
    {
        try {
            permitted('manage-email-templates');
            ...
            return Inertia::render('Settings/Communication/EmailTemplate', ['mailTemplates' => $mailTemplates]);
        } catch (\Exception $e) {
    ...
    {
        try {
            permitted('manage-email-templates', true); // Add authorization check
    ...
    {
        try {
            permitted('manage-email-templates'); // Add authorization check
