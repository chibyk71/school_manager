...
class EnrollmentService
{
    ...
    public function finalize(Enrollment $enrollment, User $actor): Enrollment
    {
        return DB::transaction(function () use ($enrollment, $actor) {
            ...
            // Revalidate Admission before any Profile/Student side effects.
            ...
            // Reject any cross-school requirement instances that may have been attached.
            ...
            // Admission already revalidated; link Student if still unset.
    ...
    /**
     * Revalidate linked Admission at finalization time.
     * Start-time acceptance is not sufficient: status/school/session may change later.
     */
    ...
    /**
     * Ensure a requirement instance's definition belongs to the enrollment's school.
     */
