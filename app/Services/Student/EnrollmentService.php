...
class EnrollmentService
{
    ...
    {
        $hasAddress = ! empty($biodata['address_line_1'])
            || ! empty($biodata['address_line_2'])
            || ! empty($biodata['city'])
            || ! empty($biodata['state'])
            || ! empty($biodata['postal_code'])
            || ! empty($biodata['country']);
        ...
        $payload = array_filter([
            'address_line_1' => isset($biodata['address_line_1']) ? trim((string) $biodata['address_line_1']) : null,
            'address_line_2' => isset($biodata['address_line_2']) ? trim((string) $biodata['address_line_2']) : null,
            'city_text' => isset($biodata['city']) ? trim((string) $biodata['city']) : null,
            'postal_code' => isset($biodata['postal_code']) ? trim((string) $biodata['postal_code']) : null,
            'landmark' => isset($biodata['state']) ? 'State: '.trim((string) $biodata['state']) : null,
            'type' => 'residential',
        ], fn ($v) => $v !== null && $v !== '');
