...
class RegistrationNumberService
{
    ...
    public const REASON_CLASS_CHANGE = 'class_change';
    ...
    public function config(School $school): array
    {
        ...
        return [
            ...
            'regenerate_on_class_change' => (bool) ($settings['regenerate_on_class_change'] ?? $settings['regenerate_on_section_change'] ?? true),
    ...
    public function shouldRegenerateOnClassChange(School $school): bool
    {
        return (bool) ($this->config($school)['regenerate_on_class_change'] ?? true);
    }
