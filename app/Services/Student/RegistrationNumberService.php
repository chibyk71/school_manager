...
class RegistrationNumberService
{
    ...
    public function assign(
        ...
        $this->assertContextBelongsToSchool($school, $context);
    ...
    /**
     * Ensure optional academic_session / class_level / class_section IDs in context
     * belong to the given school so history cannot be written with foreign context.
     */
    protected function assertContextBelongsToSchool(School $school, array $context): void
    {
        $sessionId = $context['academic_session_id'] ?? null;
        $levelId = $context['class_level_id'] ?? null;
        $sectionId = $context['class_section_id'] ?? null;
